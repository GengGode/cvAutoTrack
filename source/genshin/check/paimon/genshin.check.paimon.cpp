...
bool check_paimon_search_impl(const tianli::global::check_paimon_search_params& params, const tianli::global::GenshinScreen& genshin_screen, tianli::global::GenshinPaimon& out_genshin_paimon)
{
    ...
    if (paimon_match_maxVal >= check_match_paimon_param && paimon_match_maxVal != 1)
    {
        ...
        out_genshin_paimon.rect_paimon = cv::Rect(rect_origin.tl() + paimon_match_maxLoc, params.paimon_template.size());
    ...
    if (paimon_match_handle_mode_maxVal > check_match_paimon_param)
    {
        ...
        out_genshin_paimon.is_visial = true;
        out_genshin_paimon.rect_paimon = cv::Rect(rect_origin.tl() + paimon_match_handle_mode_maxLoc, params.paimon_template_handle_mode.size());
        out_genshin_paimon.is_search_mode = true;
