...
namespace TianLi::Utils
{
  ...
  {
    std::map<std::string, std::pair<cv::Rect2i, cv::Rect2i>> mappers{
      { "渊下宫", { cv::Rect2i(-3968, 2237, 1600, 1600),cv::Rect2i(211, 267, 2133, 2133) }},
      { "地下层岩", { cv::Rect2i(-2368, 3037, 1000, 800),cv::Rect2i(369,584,1333,1066)} },
    ...
    {
      auto srcRect = value.first + cv::Point2i(3967, 3362);
      auto dstRect = value.second + cv::Point2i(3967, 3362);

      if (key == "渊下宫" or key == "地下层岩")
      {
        dstRect -= cv::Point2i(3967, 3362);
      }
