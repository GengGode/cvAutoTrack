...
| -------------------- | ------------------------------------------------------------------ |
| `SetUseBitbltCaptureMode`         | 获取最后设置的错误码。                                               |
| `SetUseDx11CaptureMode`         | 获取最后设置的错误码。                                               |
...
| `GetTransformOfMap`       | 获取当前人物所在位置以及角度（箭头朝向）。                              |
...
| `GetLastErrStr`         | 获取最后设置的错误码。                                               |
| `GetLastErrMsg`         | 获取最后设置的错误码。                                               |
